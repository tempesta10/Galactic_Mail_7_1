...
;******************************************************************
CGameRoom_DrawHighScore proc uses ebx esi edi
    LOCAL hRes:DWORD
    LOCAL hFont:DWORD
    LOCAL xt:DWORD
    
    szText szFontNameSeas,"SeasideResortNF"
    ;-------------------------------------

    fn CTTF_LoadFontMem,hInstance,IDF_SEAS
    mov dword ptr[hRes],eax
    ;-------------------------------------
    fn CTTF_CreateFont,screen,offset szFontNameSeas,18
    mov dword ptr[hFont],eax
    ;-------------------------------------
    or eax,eax
    je @@Ret
